...
def evaluate_logregressionmodel(x_train_vec, y_train, x_dev_vec, y_dev, x_test_vec, y_test):
...
def main():
    ...
    evaluate_logregressionmodel(x_train_vec, y_train, x_dev_vec, y_dev, x_test_vec, y_test)
